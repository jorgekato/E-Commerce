 ...
 * @author Henrique
 */
public class FiltroPerfilIdadeSexoViewHelper implements IViewHelper{
    
    @Override
    public EntidadeDominio getEntidade(HttpServletRequest request) {
        
        FiltroPerfilIdadeSexo f = new FiltroPerfilIdadeSexo();
    ...
    public void setView(Resultado resultado, HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        d = request.getRequestDispatcher("LadoAdmin/Relatorios/relatperfil.jsp");
